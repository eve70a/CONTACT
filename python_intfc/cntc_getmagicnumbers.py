...
def cntc_getmagicnumbers():

#------------------------------------------------------------------------------------------------------------- 
# function [ CNTC ] = cntc_getmagicnumbers();
#
# get the dictionary with 'magic numbers' for configuring CONTACT
#
#  CNTC         - dictionary with 'magic numbers' for configuring CONTACT
#------------------------------------------------------------------------------------------------------------- 
...
# category 0: m=*, glob   - no icp needed
    ...
    # return a dictionary with 'magic numbers' for setting flags later on
    ...
    CNTC['ic_exrhs']   = 1980; # code for setting the control digit E3, EXRHS
