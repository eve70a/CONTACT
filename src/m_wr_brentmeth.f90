...
private
   ...
   ! Building blocks for Broyden method for F=3:

   public  broyden_set_state
   public  broyden_get_state
   public  broyden_solve_dxk
   public  broyden_findiff_jac
   public  broyden_jac_update
   public  broyden_print
