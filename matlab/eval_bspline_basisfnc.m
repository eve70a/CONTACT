...
% Licensed under Apache License v2.0.  See the file "LICENSE.txt" for more information.
   ...
   if (idebug>=1)
      n0 = nnz(si < tj(k)-tiny_dt);
      n1 = nnz(si > tj(nknot-k+1)+tiny_dt);
      if (n0+n1>0)
         disp(sprintf(['Warning: there are %d u-positions before and %d after basic interval ', ...
                        't=[%3.1f,%3.1f]'], n0, n1, tj(k), tj(nknot-k+1)));
      end
   end
